...
class TypingApp {
  ...
  exportStatsPDF(){
    ...
    <div class="report">
      <h1 style="display:flex;align-items:center;gap:12px;"><img src="./icon-192x192.png" alt="Velocis Logo" style="width:36px;height:36px;object-fit:contain;border-radius:8px;"> Velocis Typing — Performance Report</h1>
